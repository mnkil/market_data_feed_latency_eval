...
boost::json::value TastyworksSession::loadConfig() {
...
TastyworksSession::TastyworksSession() {
...
void TastyworksSession::authenticate() {
    try {
...
boost::json::value TastyworksSession::getQuoteToken() {
    try {
        boost::asio::io_context ioc;
        boost::asio::ssl::context ssl_context(boost::asio::ssl::context::tlsv12_client);
        ssl_context.set_default_verify_paths();
...
void TastyworksSession::closeSession() {
    boost::asio::io_context ioc;
